// Lucide-style inline icons for the patent review tool
const icPaths = {
  ...
  Pin:        ["M12 17v5", "M9 10.76V4l3-2 3 2v6.76l4 2.49V17H5v-3.75l4-2.49z"],
  Bookmark:   ["M19 21l-7-5-7 5V5a2 2 0 012-2h10a2 2 0 012 2v16z"],
  Settings:   ["M12 15a3 3 0 100-6 3 3 0 000 6z"],
  Star:       ["M12 2l3.1 6.3 6.9 1-5 4.9 1.2 6.8L12 17.8 5.8 21l1.2-6.8-5-4.9 6.9-1z"],
};

function PRIcon({ name, size = 16, color = "currentColor", strokeWidth = 1.7, style = {} }) {
...
window.PRIcon = PRIcon;

// Country flags (tiny, abstract — we represent as colored mono badges)
...
function StatusPill({ status }) {
  if (!status) {
    return <span className="pr-pill" style={{
...
// Wanted brand mark (used as the "tool" logo in the top-left corner)
function WantedMark({ size = 14 }) {
  return (
